    ...
    <div class="card-body">
        ...
        <div class="row col-md-12" >
            ...
            <div class="form-group col-md-6">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" value="{{ $trans_count }}" readonly name="" id="">
                </div>
             </div>
        ...
        <div class="row col-md-12" >
            ...
            <div class="form-group col-md-6 ">
               ...
               <div class="form-group">
                   <input type="text" class="form-control" value="عدد العروض الفعالة الفعالة" disabled name="" id="">
               </div>
            </div>
            <div class="form-group col-md-6">

                <div class="form-group">
                    <input type="text" class="form-control" value="{{ $active_offer }}" readonly name="" id="">
                </div>
             </div>
        ...
        <div class="row col-md-12" >
            ...
            <div class="form-group col-md-6">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" value="{{ $natonalits }}" readonly name="" id="">
                </div>
             </div>
        ...
        <div class="row col-md-12" >
            ...
            <div class="form-group col-md-6">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" value="{{ @$most_natonalities_use }}" readonly name="" id="">
                </div>
             </div>
